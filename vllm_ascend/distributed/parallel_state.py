...
def init_ascend_model_parallel(parallel_config: ParallelConfig, ):
    ...
    def _create_shared_weight_group(shared_weight_tp_size: int,
        ...
        if global_dp_size == 1:
            ...
            num_shared_weight_tensor_parallel_groups = (global_tp_size //
                                                        shared_weight_tp_size)
            group_ranks = []
    ...
    if flashcomm2_o_shared_enabled():
        _SHARED_WEIGHT = _create_shared_weight_group(flashcomm2_otp_size,
                                                     "flashcomm2_o_shared")
