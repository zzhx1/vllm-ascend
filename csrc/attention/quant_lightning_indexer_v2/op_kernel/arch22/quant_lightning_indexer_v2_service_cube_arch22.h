                                                          ...
                                                          const QLIV2Common::RunInfo &runInfo)
{
    ...
    uint64_t blkStride = constInfo_.keyStride0 != 0 ?
                             static_cast<uint64_t>(constInfo_.keyStride0) :
                             static_cast<uint64_t>(constInfo_.kCacheBlockSize) * constInfo_.kHeadNum *
                                 constInfo_.headDim;
