...
/*!
 * \file sparse_flash_mla_common_arch22.h
 * \brief
 */

#ifndef SPARSE_FLASH_MLA_COMMON_ARCH22_H
#define SPARSE_FLASH_MLA_COMMON_ARCH22_H
...
#endif // SPARSE_FLASH_MLA_COMMON_ARCH22_H
