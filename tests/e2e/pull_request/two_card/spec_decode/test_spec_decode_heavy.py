...
#
# Run `pytest tests/e2e/pull_request/two_card/spec_decode/test_spec_decode_heavy.py`.
#
# Heavyweight spec-decode cases (dspark / MoE-MTP hang / VWN / sliding
# window). Split from test_spec_decode.py so the two file-level targets can
# run in parallel on separate 2-card jobs.
